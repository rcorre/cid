...
Color lerp(Color start, Color end, float factor) {
  auto r = cid.util.math.lerp(start.r, end.r, factor);
  auto g = cid.util.math.lerp(start.g, end.g, factor);
  auto b = cid.util.math.lerp(start.b, end.b, factor);
  auto a = cid.util.math.lerp(start.a, end.a, factor);
